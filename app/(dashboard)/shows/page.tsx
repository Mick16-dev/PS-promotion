          ...
          filteredShows.map((show) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-medium text-muted-foreground/40">{show.date} • {show.city}</p>
              </div>
              ...
              <div className="flex items-center gap-10 w-full md:w-auto px-4">
                <div className="flex flex-col items-end gap-2 pr-6 border-r border-white/5">
                   <div className="flex items-center gap-3">
                      <span className="text-xs font-bold uppercase tracking-widest text-muted-foreground/30">Materials</span>
