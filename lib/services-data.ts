 ...
 *
 * Source: https://rotek.de/leistungen/ (and each linked service page)
 * Notes:
 * - No invented services; copy is derived from the public Rotek pages.
 * - Imagery uses Rotek's own published assets.
 */
...
export interface ServiceContent {
   ...
   * Rotek does not publish fixed entry prices on the service catalog pages.
   */
  fromPrice?: number
  /** Rotek-published imagery */
  beforeImage?: string
  afterImage: string
...
export const services: ServiceContent[] = [
  {
    ...
    introEn:
      'Sediments build up over years and reduce the inner diameter of pipes until a full blockage occurs. Rotek uses modern equipment to clear blockages quickly, cleanly, and with a long-term result.',
    introDe:
      'Über Jahre setzen sich Sedimente an den Innenwänden ab, der Rohrdurchmesser wird kleiner – bis zur vollständigen Verstopfung. Rotek arbeitet mit modernster Technik, um das Problem schnell, sauber und langfristig zu lösen.',
    whatWeDoEn: [
  ...
  },
  {
    ...
    introEn:
      'Even large-diameter sewers can clog due to roots or sediments. Rotek offers 24-hour availability and uses electromechanical cleaning and hydrodynamic high-pressure jetting depending on the blockage.',
    introDe:
      'Auch Kanäle mit großem Durchmesser können durch Wurzelwerk oder Sedimente verstopfen. Rotek ist mit 24-Stunden-Service erreichbar und setzt – je nach Fall – elektromechanische Reinigung sowie Hochdruckspülung ein.',
    whatWeDoEn: [
  ...
  },
  {
    ...
    introEn:
      'CCTV inspection is essential for new acceptance and inspection of existing sewers. Modern TV systems reduce excavation and demolition work to a minimum and support targeted rehabilitation planning.',
    introDe:
      'Die Kanal-TV-Untersuchung ist für Neuabnahmen und die Inspektion bestehender Kanäle unverzichtbar. Moderne TV-Anlagen minimieren Grabungen und Abrissarbeiten und unterstützen die gezielte Sanierungsplanung.',
    whatWeDoEn: [
  ...
  },
  {
    ...
    introEn:
      'Inspection of side sewers from the main sewer. The used satellite technology enables simultaneous flushing, inspection and measurement.',
    introDe:
      'Untersuchung von Nebenkanälen vom Hauptkanal aus. Die verwendete Satellitentechnik ermöglicht gleichzeitiges Spülen, Inspizieren und Vermessen.',
    whatWeDoEn: [
  ...
  },
  {
    ...
    introEn:
      'Lifting stations transport wastewater from below the backflow level into the sewer connection. Regular maintenance is recommended and regulated in DIN EN 12056-4.',
    introDe:
      'Hebeanlagen leiten Abwässer unterhalb der Rückstauebene in den Kanalisationsanschluss. Regelmäßige Wartung ist sinnvoll und in der DIN EN 12056-4 geregelt.',
    whatWeDoEn: [
  ...
  },
  {
    ...
    introEn:
      'Grease separators must be operated and serviced according to standards. Rotek cleans separators efficiently and disposes of fats and sludges properly.',
    introDe:
      'Fettabscheider sind nach Norm zu betreiben und regelmäßig durch sachkundige Fachbetriebe zu reinigen. Rotek übernimmt Reinigung und ordnungsgemäße Entsorgung von Fetten und Schlämmen.',
    whatWeDoEn: [
  ...
  },
  {
    ...
    introEn:
      'Tightness protects the environment and prevents moisture damage. Rotek performs tightness tests across different systems and provides the required protocols for authorities.',
    introDe:
      'Dichtheit schützt Umwelt und verhindert Nässeschäden. Rotek führt Dichtheitsprüfungen in verschiedenen Systemen durch und erstellt die geforderten Protokolle als Nachweis.',
    whatWeDoEn: [
  ...
  },
  {
    ...
    introEn:
      'Property owners are responsible for maintaining private wastewater lines. Rotek offers cost-effective rehabilitation methods (including epros method with DIBt approval) where excavation is often unnecessary.',
    introDe:
      'Grundstückseigentümer sind zur Instandhaltung privater Abwasserleitungen verpflichtet. Rotek bietet kostengünstige Sanierungsmethoden (u. a. epros mit DIBt-Zulassung), bei denen Aufgraben oftmals entfällt.',
    whatWeDoEn: [
